...
class ReportPgReceiptWidget extends StatelessWidget {
  final ReportPgModel? reportPgModelData;
  final int openingVehicleCount;
  final String currentDate;
  final int totalIn;
  final int totalOut;
  final int totalPending;

  const ReportPgReceiptWidget({this.reportPgModelData,
    required this.openingVehicleCount,
    required this.currentDate,required this.totalIn,required this.totalOut,required this.totalPending,
    super.key});
        ...
        children: [
          ...
          const Row(
            children: [
              ...
              Expanded(
                  child: SettlementHeaderWidget(
                      title: 'In', materialColor: Colors.black)),
              Expanded(
                  child: SettlementHeaderWidget(
                      title: 'Out', materialColor: Colors.black)),
              Expanded(
                  child: SettlementHeaderWidget(
                      title: 'Pending', materialColor: Colors.black)),
            ],
          ),
          Row(
            children: [
